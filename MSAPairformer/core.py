...
from torch.nn import Linear, Sequential, LayerNorm, RMSNorm
...
class Transition(Module):
    ...
    def __init__(
        ...
        # We apply PreRMSNorm to these transition layers so it's okay not to do it here
        self.ff = Sequential(
