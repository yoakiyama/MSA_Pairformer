...
def load_model(pairwise_repr_layer_idx):
    ...
    checkpoint_path = "/home/ubuntu/MSA_Pairformer/model_checkpoints/train_final_model/model_step_18000.pt"
    model = MSAPairformerContactModel(
        pretrained_weights_path=checkpoint_path,
        pretrained_is_final=False,
...
def main():
    ...
    nLayers = 22
    model_out_dir = "/home/ubuntu/MSA_Pairformer/model_checkpoints/train_contacts_presoftmax_diff_attn_all_layers_v4/"
    ...
    for layer_idx in range(nLayers):
        ...
        experiment_name = f"presoftmax_diff_attn_all_layers_v4_trRosetta_layer_{layer_idx}"
        wandb.init(
        ...
        torch.save(
            ...
            f"presoftmax_diff_attn_all_layers_v4_trRosetta_layer_{layer_idx}.pt")
        )
