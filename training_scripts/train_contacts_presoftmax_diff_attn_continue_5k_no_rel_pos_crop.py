...
from MSAPairformer.dataset import aa2tok_d, prepare_inputs, MSAConfindContactMapDataset, prepare_inputs_bf16, MSA, ConfindContactMap
...
def load_model(pairwise_repr_layer_idx):
    ...
    checkpoint_path = "/home/ubuntu/MSA_Pairformer/model_checkpoints/train_presoftmax_diff_attn_continue_5k_no_rel_pos_crop/model_final.pt"
...
def main():
    ...
    nLayers = 22
    model_out_dir = "/home/ubuntu/MSA_Pairformer/model_checkpoints/train_contacts_presoftmax_diff_attn_continue_5k_no_rel_pos_crop/"
    ...
    for layer_idx in range(15, nLayers):
        ...
        experiment_name = f"presoftmax_diff_attn_continue_5k_no_rel_pos_crop_trRosetta_layer_{layer_idx}"
        wandb.init(
        ...
        torch.save(
            ...
            f"presoftmax_diff_attn_continue_5k_no_rel_pos_crop_trRosetta_layer_{layer_idx}.pt")
        )
